...
<body>
    ...
    <script src="{{assets('../assets/vendors/flatpickr/flatpickr.min.js')}}"></script>
    <script src="{{assets('../assets/vendors/apexcharts/apexcharts.min.js')}}"></script>
    ...
    <script src="{{assets('../assets/js/dashboard-dark.js')}}"></script>
